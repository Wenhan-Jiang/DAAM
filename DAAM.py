...
class DAAM(Optimizer):
    r"""Implements DAAM: Dual Averaging Adaptive Moment Estimation for Accelerating Deep Model Training.
    ...
    def __init__(self, params, lr=1e-3, momentum=0.9, eps=1e-8, weight_decay=0, grad_sq_factor=2.5e-4,
        ...
        super(DAAM, self).__init__(params, defaults)
